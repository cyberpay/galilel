...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zgalispends need to use the cs_spendcache
...
public:
    ...
    std::string GetUniqueWalletBackupName(bool fzgaliAuto) const;
