...
#ifndef GALI_ZGALITRACKER_H
#define GALI_ZGALITRACKER_H
...
public:
    CzGALITracker(std::string strWalletFile);
    ~CzGALITracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzGALIWallet* zGALIWallet = NULL);
