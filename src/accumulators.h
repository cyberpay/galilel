...
#ifndef GALI_ACCUMULATORS_H
#define GALI_ACCUMULATORS_H
...
bool GenerateAccumulatorWitness(const libzerocoin::PublicCoin &coin, libzerocoin::Accumulator& accumulator, libzerocoin::AccumulatorWitness& witness, int nSecurityLevel, int& nMintsAdded, bool& isBrokenChecksum, std::string& strError, CBlockIndex* pindexCheckpoint = nullptr);
