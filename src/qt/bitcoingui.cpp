                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Galilel Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GALI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and galilel: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGALI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Galilel Core"), this);
    aboutAction->setStatusTip(tr("Show information about Galilel Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Galilel"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GALI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verifymessage"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GALI addresses"));
    ...
    openBootstrapAction = new QAction(QIcon(":/icons/blockchain"), tr("&Blockchain Bootstrap"), this);
    ...
    openAction = new QAction(QIcon(":/icons/openfile"), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a GALI: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Galilel Core help message to get a list with possible Galilel command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Galilel Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Galilel network", "", count));
}
...
{
    QString strTitle = tr("Galilel Core"); // default title
