...
/** Utility functions used by the Galilel Qt UI.
 */
namespace GUIUtil
{
...
// Render GALI addresses in monospace font
...
// Parse "galilel:" URI into recipient object, return true on successful parsing
